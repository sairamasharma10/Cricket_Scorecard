...
public class ScoreCard 
{
	...
	public void SetButton(String bno,boolean wide,boolean noball)
	{
		if(ballCount==6)
		{
			...
			try {
				u.setData(bowler.getText(),overs.getText(), runsb.getText(), maiden.getText(), wicketsb.getText());
			} catch (Exception e) {
	...
	public void scoreConvert(int i,boolean wt,boolean wi,boolean no)
	{
		...
		if(wt==true)
		{
			...
			try 
			{
				bb.setData(batsman1.getText(), runs1.getText(), balls1.getText(),four1.getText() , six1.getText());
			} 
			catch (Exception e) 
			{
				// TODO Auto-generated catch block
